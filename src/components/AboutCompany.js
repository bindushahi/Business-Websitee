  ...
  return (
    <section className="about-company">
      <div className="container">
        <h2>About CodePulse </h2>
        <p>
          Welcome to CodePulse – your gateway to innovation in Nepal. We
          specialize in delivering cutting-edge solutions, ranging from bespoke
          software development to strategic IT consulting. At CodePulse, we believe in
          ...
          experiences, or embark on a digital transformation journey, CodePulse
          ...
          curve, ensuring your business is equipped for success. Join us at CodePulse
